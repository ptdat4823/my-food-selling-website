      ...
      <div className="flex flex-row gap-4">
        ...
        <div className="relative flex-1">
          <div className="w-auto flex flex-col gap-2 justify-start">
            <div className="w-[60vw] text-primary-word dark:text-dark-primary-word text-2xl font-semibold capitalize truncate">
              {cart.food.name}
            </div>
            <div className="w-[40vw] text-secondary-word dark:text-dark-secondary-word text-lg capitalize truncate">
            ...
            >
              ...
              <span className="w-full text-primary-word dark:text-dark-primary-word line-clamp-3 overflow-hidden text-ellipsis">
                {cart.note}
              </span>
            </div>
          </div>
